...
public class PlayerScript : MonoBehaviour
{
    ...
    // Get other scripts
    [FormerlySerializedAs("cardScript")] public Card card;   
    public DeckScript deckScript;
    public GameObject[] hand;                    // Array of card objects on table
    public int cardIndex = 0;                   // Index of next card to be turned over
    public int handValue = 0;     // Total value of player/dealer's hand
    
    private int money = 1000;     // Betting money
    private List<Card> aceList = new List<Card>();     // Tracking aces for 1 to 11 conversions
